    ...
    <div class="w-full">
        ...
        <div class="w-full space-y-4 sm:space-y-0 sm:flex justify-between sm:mt-4">
            ...
            <div class="relative">
                ...
                <button class="absolute top-0 right-0 rounded-l-none btn sm:btn-sm btn-primary hover:bg-primary cursor-default"><i class="fas fa-lg fa-search"></i></button>
            </div>
        </div> 
        ...
        <!-- Table footer -->
        <div class="flex-col flex sm:flex-row-reverse justify-between py-3 rounded-lg bg-white text-center space-y-4 sm:space-y-0 px-3 items-center">
...
export default {
    ...
    setup(props) {
        ...
        const params = reactive({
            ...
            filter: props.filters.filter  ? props.filters.filter : ref(0)
        })
