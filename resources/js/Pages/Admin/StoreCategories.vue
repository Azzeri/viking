...
<PhotoModal :item_id=categoryForPhotoForm.id :show=photoModalOpened :src=categoryForPhotoForm.photo_path path='storeCategories' @closePhotoModal=closePhotoModal></PhotoModal>
</template>
...
export default defineComponent({
	...
	setup(props) {
		...
		const categoryForPhotoForm = props.categories.length ? ref(props.categories.data[0]) : ref(0)
